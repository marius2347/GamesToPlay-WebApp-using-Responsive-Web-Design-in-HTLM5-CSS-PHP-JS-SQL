...
<head>
    ...
    <title>GamesToPlay | Terms Of Use</title>
    <link rel="stylesheet" href="./styles/index.css">
    <link rel="stylesheet" href="./styles/termsofuse.css">
...
<body>
    ...
    <div class="content">
        ...
        <br>
        <p class="text">These terms and conditions outline the rules and regulations for the use of GamesToPlay's Website.</p>
        <p class="text">By accessing this website we assume you accept these terms and conditions. Do not continue to use GamesToPlay if you
            do not agree to take all of the terms and conditions stated on this page.</p>
        <p class="text">The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
        ...
        <h3>Cookies</h3>
        <br>
        <p class="text">We employ the use of cookies. By accessing GamesToPlay, you agreed to use cookies in agreement with the <a href="./privacypolicy.php">GamesToPlay's
                Privacy Policy</a>.</p>
        <p class="text">Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our
        ...
        <br>
        <p class="text">Unless otherwise stated, GamesToPlay and/or its licensors own the intellectual property rights for all material on
            GamesToPlay. All intellectual property rights are reserved. You may access this from GamesToPlay for your own
            personal use subjected to restrictions set in these terms and conditions.</p>
        <p class="text">You must not:</p>
        <br>
        <ul class="list">
            <li>Republish material from GamesToPlay</li>
            <li>Sell, rent or sub-license material from GamesToPlay</li>
            <li>Reproduce, duplicate or copy material from GamesToPlay</li>
            <li>Redistribute content from GamesToPlay</li>
        </ul>
        <br>
        <p class="text">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
            of the website. GamesToPlay does not filter, edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of GamesToPlay,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, GamesToPlay shall not be liable for the Comments or for any liability, damages or expenses caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
        <p class="text">GamesToPlay reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <br>
        <p class="text">You hereby grant GamesToPlay a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
        ...
        <br>
        <p class="text">These organizations may link to our home page, to publications or to other Website information so long as the link:
        ...
        <p class="text">We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of GamesToPlay; and (d)
            the link is in the context of general resource information.</p>
        <p class="text">These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not
        ...
        <p class="text">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
            must inform us by sending an e-mail to GamesToPlay. Please include your name, your organization name, contact
        ...
        <br>
        <p class="text">No use of GamesToPlay's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
        <br>
        <h3><strong>iFrames</strong></h3>
        <br>
        <p class="text">Without prior approval and written permission, you may not create frames around our Webpages that alter in any way
            the visual presentation or appearance of our Website.</p>
        <br>
        <h3><strong>Content Liability</strong></h3>
        <br>
        <p class="text">We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us
        ...
        <br>
        <p class="text">We reserve the right to request that you remove all links or any particular link to our Website. You approve to
        ...
        <br>
        <p class="text">If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any
            moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.
        </p>
        <p class="text">We do not ensure that the information on this website is correct, we do not warrant its completeness or accuracy; nor
            do we promise to ensure that the website remains available or that the material on the website is kept up to date.
        </p>
        <br>
        <h3><strong>Disclaimer</strong></h3>
        <br>
        <p class="text">To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating
        ...
        <br>
        <p class="text">The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are subject
        ...
        <p class="text">As long as the website and the information and services on the website are provided free of charge, we will not be
